...
approach: >-
  ...
  + highlights). Store as data_out.json rows with fields: {id, document, reference_summary, source}. Also extract a mini split
  of 100 examples. Validate schema with aii-json.
depends_on: []
</artifact_direction>
