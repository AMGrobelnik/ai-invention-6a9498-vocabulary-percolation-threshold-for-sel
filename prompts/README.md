...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 3 task(s)
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 8 prompt(s)
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_evaluation_1.md` — 6 prompt(s)
  ...
  - round_2
    ...
    - `3_gen_art/` — 2 task(s)
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_evaluation_1.md` — 17 prompt(s)
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 14 prompt(s)
    - `prompts/2_test_idea/round_2/4_gen_paper_text.md` — 4 prompt(s)
    - `prompts/2_test_idea/round_2/5_review_paper.md` — 2 prompt(s)
    - `prompts/2_test_idea/round_2/6_upd_hypo.md` — 2 prompt(s)
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 3 task(s)
    - `prompts/3_report_results/1_gen_viz/gen_viz_1.md` — 3 prompt(s)
    - `prompts/3_report_results/1_gen_viz/gen_viz_2.md` — 3 prompt(s)
  ...
  - `2_gen_demo_art/` — 5 task(s)
    ...
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_1.md` — 7 prompt(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_2.md` — 7 prompt(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 10 prompt(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 11 prompt(s)
